...
if($key == "4336f0f199bd35b3275e7b77e6471da3985f963b")
{
	...
	if($lang_flag=="1"){
		...
		$a = mysqli_query($con,"SELECT fid,cid,$colq as colq,$cola as cola FROM `faq` where status=1");
		while($row = mysqli_fetch_array($a))
		{
				...
				$arr[] = array('fid' => $row['fid'],'question' => $row['colq'],'answer' => $row['cola'],'category' => $row4['col'],'subcategory' => $row3['col'],'totallikes' => $countlike,'liked' => $liked,'stared' => $star);	
