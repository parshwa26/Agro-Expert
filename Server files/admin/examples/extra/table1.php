...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            <h3 style="padding: 10px 0px 0px 20px;">No. of User</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form action="export1.php" method='post'><button class="btn btn-primary" name="export">Download Excel</button></form>
                            </div>
                        </div>
                    </div>
                </div>
