...
import com.agroexpert.expert.Bean.BeanDistrict;
...
public class AdapterDistrict extends BaseAdapter {
    ...
    private ArrayList<BeanDistrict> list;
    Context mContext;
    LayoutInflater inflter;

    public AdapterDistrict(ArrayList<BeanDistrict> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, @Nullable View listItemViewconvertView, @NonNull ViewGroup parent) {
        ...
        tv_title.setText(list.get(position).district);
        tv_id.setText(list.get(position).did);
        return listItemView;
