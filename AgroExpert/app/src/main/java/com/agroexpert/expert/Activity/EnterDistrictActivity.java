...
import com.agroexpert.expert.Adapter.AdapterDistrict;
...
public class EnterDistrictActivity extends Activity {
    ...
    public void getdistrict(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST , AppConstants.district, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
