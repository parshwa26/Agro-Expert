...
if($key == "4336f0f199bd35b3275e7b77e6471da3985f963b")
{
	...
	$arr = array();
		...
		$a = mysqli_query($con,"SELECT q.question,q.cid,c.level,c.pid,q.qid,c.$col as col FROM question q,category c WHERE q.lid=$lid AND q.expertid=0 AND q.cid=c.cid ORDER BY q.qid DESC");
