...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            <h3 style="padding: 10px 0px 0px 20px;">Question By Distict</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                             ...
                                             $result6= mysqli_query($con,"select b.district as district,COUNT(a.qid) as questions from question a,login b where a.lid=b.lid group by b.district ");
                                            
                                            while($row1=mysqli_fetch_array($result6))
                                            {   
                                                echo "<tr><td>".$row1['district']."</td>";
                                ...
                                <form action="export3.php" method='post'><button class="btn btn-primary" name="export">Download Excel</button></form>
                            </div>
                        </div>
                    </div>
                </div>
