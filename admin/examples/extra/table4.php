...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            <h3 style="padding: 10px 0px 0px 20px;">Question Asked By category</h3>
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table">
                                        ...
                                        //      echo   "<tr><td>".$row['ecategory_flag']."</td>";
                                             $result1= mysqli_query($con,"select a.ecategory_flag as category,COUNT(b.qid) as questions from category a,question b where a.cid=b.cid  group by a.ecategory_flag ");
